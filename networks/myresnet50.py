...
class ResNet50(ResNet):
    ...
    def load_state_dict(self, state_dict):
        ...
        state_dict['fc2.weight'] = torch.cat((state_dict['fc.weight'], state_dict['fc.weight'][0,:]), dim=0)
        state_dict['fc2.bias'] = torch.cat((state_dict['fc.bias'], state_dict['fc.bias'][0, :]), dim=0)
